...
const octokit = new Octokit({
  auth: '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'
});
const api = new Gitlab({
  host: 'https://gitlab.com',
  token: 'glpat-7zsFt_JNnzdbVpzu4o17'
});
...
const branchName = "new-branchForDemo";
...
console.log(eventData)
  ...
  const option1 = {
    ...
    headers: {
      'PRIVATE-TOKEN': 'glpat-7zsFt_JNnzdbVpzu4o17' // Replace with your GitLab private token
    },
    json: {
...
const option3 = {
  ...
  headers: {
    'PRIVATE-TOKEN': 'glpat-7zsFt_JNnzdbVpzu4o17'
  },
  body: {
    branch: branch,
    content: fileContent,
